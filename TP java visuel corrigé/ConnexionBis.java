...
class ConnexionBis extends JFrame implements ActionListener {
    ...
    public ConnexionBis() {
       ...
       //Positionnement des trois panels
        ...
        //Gestion des évenements des boutons
        jBtnOk.addActionListener(this);
        jBtnNon.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jBtnOk) {
            System.out.println("Login : "+jTxtField1.getText());
            char[] pw = jPwdField.getPassword().toString().toCharArray();
            System.out.println("Password : "+ pw);
        }
        else if (e.getSource() == jBtnNon)
            System.exit(0);
    }
}